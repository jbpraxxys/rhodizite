<template>
    <section class="relative lg:h-screen">
        <div
            class="px-4 lg:px-20 pt-[141px] lg:pt-[150px] lg:absolute lg:top-0 lg:left-0 z-[2] lg:bg-transparent bg-primary-900 lg:h-auto h-screen">
...
// onMounted(() => {
//     const delay = isLargeScreen.value ? 5000 : 2500 // 1.5 seconds for desktop, 5 seconds for mobile
//     setTimeout(() => {
