    ...
    <section class="bg-primary-50">
        <div class="px-4 lg:px-20 pb-[120px] max-w-[1440px] m-auto">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <cards-career-card 
                    v-for="item in cms?.content.section2_items"
                    :item="item"
    ...
    <section class="relative z-[2] bg-primary-50">
        ...
        <div class="max-w-[1440px] m-auto lg:pb-20 px-4 py-16 lg:px-20">
            <div class="text-center mb-10 lg:mb-10">
                <p class="text-5xl font-bold">{{cms?.content.section4_header}}</p>
            </div>
            <div>
                <Lightgallery
                    :settings="{ 
            ...
            <div class="relative pt-20">
                ...
                <sections-career-form 
                    :position="position" 
                    :title="cms?.content.section5_title "
                    :description="cms?.content.section5_content"
                />
            </div>
        </div>
    </section>
